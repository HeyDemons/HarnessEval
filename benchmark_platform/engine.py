...
HARNESS_ENV = frozenset({
    ...
    "HARNESS_API_STREAM",
    "HARNESS_USER_AGENT",
    "HARNESS_AFLOW_OPT_API_BASE",
    "HARNESS_AFLOW_OPT_API_TYPE",
    "HARNESS_AFLOW_OPT_API_AUTH",
    "HARNESS_AFLOW_OPT_API_USER_AGENT",
    "HARNESS_AFLOW_OPT_API_KEY",
    "HARNESS_AFLOW_OPT_MODEL",
    "HARNESS_AFLOW_OPT_TEMPERATURE",
    "HARNESS_AFLOW_OPT_API_TIMEOUT_S",
    "HARNESS_AFLOW_OPT_API_RETRIES",
    "HARNESS_AFLOW_OPT_MAX_OUTPUT_TOKENS",
    "HARNESS_AFLOW_OPT_REASONING_EFFORT",
    "HARNESS_AFLOW_OPT_API_STREAM",
    "HARNESS_SA_API_BASE",
    "HARNESS_SA_API_TYPE",
    "HARNESS_SA_API_AUTH",
...
class Platform:
    ...
    def _run_terminal_profile(
        ...
        request = {
            ...
            "timeout_policy": "official_task_phase_timeouts",
